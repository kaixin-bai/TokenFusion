...
# GENERAL
FREEZE_BN = True
NUM_SEGM_EPOCHS = [100] * 4  # [100] * 3  # [150] * 3 if using ResNet152 as backbone
PRINT_EVERY = 10
RANDOM_SEED = 42
VAL_EVERY = 5  # how often to record validation scores

# OPTIMISERS' PARAMETERS
LR_ENC = [5e-4, 2.5e-4, 1e-4, 1e-4]  # [5e-4, 2.5e-4, 1e-4]  # TO FREEZE, PUT 0
LR_DEC = [3e-3, 1.5e-3, 7e-4, 7e-4]
